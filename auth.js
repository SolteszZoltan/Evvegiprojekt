...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (user) {
        ...
        const avatarData = localStorage.getItem('pronyo_avatar_' + user.email) || '';
        const avatarHTML = avatarData
            ? `<span style="width:24px;height:24px;border-radius:50%;overflow:hidden;display:inline-flex;flex-shrink:0;"><img src="${avatarData}" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"></span>`
            : `<span style="width:24px;height:24px;border-radius:50%;background:#F8D800;color:#000;display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:900;">${initial}</span>`;
        authBtn.innerHTML = `
            ${avatarHTML}
    ...
    dropdown.innerHTML = `
        ...
        <div class="auth-dd-items">
            ...
            <a href="rendeleseim.html" class="auth-dd-item">
                <span class="dd-icon"><i class="fas fa-box"></i></span>
                <span>Rendeléseim</span>
            </a>
            <a href="kedvenceim.html" class="auth-dd-item">
                <span class="dd-icon"><i class="fas fa-heart"></i></span>
                <span>Kedvenceim</span>
            </a>
            <a href="profil-beallitasok.html" class="auth-dd-item">
